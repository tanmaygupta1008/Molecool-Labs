...
export default function Phase1ReactantEditorPage() {
    const { selectedReactionId, setSelectedReactionId, script, addAtom, updateAtomPosition, updateAtomCharge, updateAllAtomPositions, removeAtom, addBond, removeBond, updateBond, createGroup, removeGroup, updateGroupCharge, clearScript, loadScript } = useReactionEditor();
    ...
    const handleSave = async () => {
        ...
        setIsSaving(true);
        try {
            // Find existing reaction to preserve other fields
        ...
        <div className="w-full h-[calc(100vh-64px)] bg-black text-white flex overflow-hidden">
            ...
            <div className="w-80 bg-gray-900 border-r border-cyan-800 flex flex-col z-10 shadow-2xl shrink-0">
                <div className="p-4 border-b border-gray-800">
                    <h1 className="text-xl font-bold text-cyan-400">Reactant Editor</h1>
                    <p className="text-xs text-gray-400 mt-1">Visually construct the `atoms` and `bonds` JSON.</p>
                </div>
                ...
                <div className="p-4 flex-1 overflow-y-auto flex flex-col gap-6">
                    ...
                    <div>
                        ...
                        <div className="mt-4 pt-4 border-t border-gray-800">
                            ...
                            <p className="text-[10px] text-gray-500 mt-1 leading-tight">Continuously applies repulsive forces to bonds, arranging atoms into minimum-energy 3D geometry.</p>
                        </div>
                    </div>
                ...
                <div className="p-4 border-t border-gray-800 flex flex-col gap-2">
                    <button
                        onClick={handleSave}
                        disabled={isSaving || selectedReactionId === 'new_reaction'}
                    ...
                    >
                        {isSaving ? 'Saving to JSON...' : 'Save state to reactions.json'}
                    </button>
